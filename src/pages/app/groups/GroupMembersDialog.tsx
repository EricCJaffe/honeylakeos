...
export function GroupMembersDialog({
    ...
    onError: (error) => {
      toast.error(getToastMessage(error, {
        contextMessages: { 
          ...
          "23505": "This user is already a member of this group."
        }
      }));
    },
  });
  ...
  const removeMember = useMutation({
    ...
    onError: (error) => {
      toast.error(getToastMessage(error, {
        contextMessages: { 
          "42501": "Cannot remove the last manager from this group."
        }
      }));
      setMemberToRemove(null);
    },
  ...
  const updateRole = useMutation({
    ...
    onError: (error) => {
      toast.error(getToastMessage(error, {
        contextMessages: { 
          "42501": "Cannot demote the last manager in this group."
        }
      }));
    },
  });
