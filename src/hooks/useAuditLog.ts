...
export type AuditAction =
  ...
  | "partner_profile.updated"
  | "partner_profile.archived"
  | "partner_profile.unarchived"
  | "partner_profile.deleted"
  // Department actions
  | "department.created"
  | "department.updated"
  | "department.deleted"
...
// Backup actions
  ...
  // Partner monetization actions
  | "partner_plan.created"
  | "partner_plan.updated"
  | "partner_plan.deactivated"
  | "attribution.created"
  | "attribution.updated"
